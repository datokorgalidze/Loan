...
/* harmony import */ var _modules_addCards__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/addCards */ "./src/js/modules/addCards.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  slider.render();
  var secondPageSlider = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.moduleapp',
    btns: '.next'
  });
  secondPageSlider.render();
  var palyer = new _modules_videoPlayer__WEBPACK_IMPORTED_MODULE_1__["default"]('.showup .play', '.overlay');
  palyer.play();
  new _modules_videoPlayer__WEBPACK_IMPORTED_MODULE_1__["default"]('.module__video-item .play', '.overlay').play();
  new _modules_videoPlayer__WEBPACK_IMPORTED_MODULE_1__["default"]('.video .play', '.overlay').play();
  var minislider = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  feedSlider.init();
  new _modules_addCards__WEBPACK_IMPORTED_MODULE_3__["default"]('.officerold', '.officernew', '.officer__card-item').init();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return AddCards; });
...
/*#__PURE__*/
function () {
  function AddCards(oldSelector, newSelector, items) {
    _classCallCheck(this, AddCards);
      ...
      this.forms.forEach(function (form) {
        form.addEventListener('submit', function (e) {
          ...
          _this.postData(_this.path, formData).then(function (res) {
            ...
            statusMessage.tagName = _this.message.failure;
          }).finally(function () {
...
/***/ "./src/js/modules/slider/slider-classes.js":
/*!*************************************************!*\
  !*** ./src/js/modules/slider/slider-classes.js ***!
  \*************************************************/
/*! exports provided: default */
...
/* harmony import */ var _slider_classes__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./slider-classes */ "./src/js/modules/slider/slider-classes.js");
...
function (_Slider) {
    ...
    value: function bindTriggers() {
      ...
      this.btns.forEach(function (item) {
        item.addEventListener('click', function () {
          ...
          _this2.slides[_this2.slideIndex - 1].classList.add('animated', 'slideInUp');
        });
        item.parentNode.previousElementSibling.addEventListener('click', function (e) {
          ...
          _this2.slides[0].classList.add('animated', 'slideInUp');
        });
      });
      document.querySelectorAll('.prevmodule').forEach(function (elem) {
        elem.addEventListener('click', function (e) {
          ...
          _this2.slides[_this2.slideIndex - 1].classList.remove('animated', 'slideInLeft');

          _this2.slides[_this2.slideIndex - 1].classList.add('animated', 'slideInRight');
        });
      });
      document.querySelectorAll('.nextmodule').forEach(function (elem) {
        elem.addEventListener('click', function (e) {
          e.preventDefault();
          e.stopPropagation();
          ...
          _this2.slides[_this2.slideIndex - 1].classList.remove('animated', 'slideInRight');

          _this2.slides[_this2.slideIndex - 1].classList.add('animated', 'slideInLeft');
        });
      });
    }
  }, {
  ...
  return MainSlider;
}(_slider_classes__WEBPACK_IMPORTED_MODULE_9__["default"]);
...
/* harmony import */ var _slider_classes__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./slider-classes */ "./src/js/modules/slider/slider-classes.js");
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    value: function nextSlide() {
      ...
      var firstNonButtonSlide = Array.from(this.slides).find(function (slide) {
      ...
      if (firstNonButtonSlide) {
        ...
        this.slides[this.slideIndex - 1].classList.add('animated', 'slideInLeft'); // console.log(this.slides[this.slideIndex -1]);
  ...
  return MiniSlider;
}(_slider_classes__WEBPACK_IMPORTED_MODULE_11__["default"]);
...
/*#__PURE__*/
function () {
  function VideoPlayer(triggers, modal) {
